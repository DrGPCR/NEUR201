...
| **Unit 1 Data Analysis Assignment** — Colocalization analysis of a confocal image | Detect Alexa 488⁺ (GSTπ) and Alexa 594⁺ (Olig2) cells in a real `.czi` image and find the double-positive, colocalized cells. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DrGPCR/NEUR201/blob/main/Unit_1/notebooks/Unit_1_Data_Analysis_Assignment_STUDENT.ipynb) |
| **Unit 1 Statistics Assignment** — Olig2⁺GSTπ⁺ density in CON and DRUG | Work through histograms, central tendency, and dispersion on a 40-image dataset to ask whether the drug changes mature oligodendrocyte density. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DrGPCR/NEUR201/blob/main/Unit_1/notebooks/Unit_1_Statistics_Assignment_STUDENT.ipynb) |
